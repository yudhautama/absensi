...
class Tbl_keluarga_model extends CI_Model
{
  ...
  {
      $data = $this->db->query('select * from family '.$where);
      return $data;
  }

}

/* End of file Tbl_keluarga_model.php */
/* Location: ./application/models/Tbl_keluarga_model.php */
