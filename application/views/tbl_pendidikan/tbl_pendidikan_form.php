            ...
            <div class="row">
              ...
              <div class="col-md-4">
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                     <div class="form-group">
                      ...
                      <?php foreach($nik as $row) { ?>
                        <option value="<?php echo $row['nama_kyn'] ?>"><?php echo $row['nik'] ?></option>
                      <?php } ?>
                    </select>
                  </div>
                  <div class="form-group">
                  ...
                  <a href="<?php echo site_url('tbl_pendidikan') ?>" class="btn btn-default">Cancel</a>
                </form>
              </div>
            </div>
          </div>
