              ...
              <div class="card card-primary">
                ...
                <form role="form">
                  <div class="card-body">
                    <table class="table">
                    <?php 
                          $query=$this->Tbl_detail_absen_model->karyawan($nik);
                          foreach ($query->result() as $row){
                            ?>
                     <tr><td>Nama</td><td><?php echo $row->nama_kyn; ?></td></tr>
                     <tr><td>Jenis Absen</td><td><?php echo $j_absen; ?></td></tr>
                     <tr><td>Tanggal</td><td><?php echo $tgl; ?></td></tr>
                     <tr><td>Jam</td><td><?php echo $jam; ?></td></tr>
                     <tr><td>Keterangan</td><td><?php echo $keterangan; ?></td></tr>
                     <tr><td></td><td><a href="<?php echo site_url('tbl_detail_absen') ?>" class="btn btn-default">Cancel</a></td></tr>
                     <?php }?>
                   </table>
                 </div>
               </div><!-- /.container-fluid -->
