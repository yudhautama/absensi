                ...
                <form role="form">
                  <div class="card-body">
                   <div class="form-group">
                    ...
                    <select class="form-control form-control-sm" name="nama_kyn" id="nama_kyn" placeholder="Jenis Absen" >
                      <option>--Pilih Karyawan--</option>
                      <?php foreach($select_nama_karyawan as $row) { ?>
                        <option value="<?php echo $row['nama_kyn'] ?>" <?php if($nik){if($nik == $row['nik']){echo 'selected'; } } ?> >
                          <?php echo $row['nama_kyn'] ; ?>
                        </option>
                      <?php } ?>
                    </select>
                    <div class="form-group">
                      ...
                      <select class="form-control form-control-sm" name="j_absen" id="j_absen" placeholder="Jenis Absen" >
                        ...
                        <?php foreach($select_jenis_absen as $row) { ?>
                          <option value="<?php echo $row['j_absen'] ?>" <?php if($j_absen){if($j_absen == $row['j_absen']){echo 'selected'; } } ?>>
