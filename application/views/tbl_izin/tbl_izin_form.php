                ...
                <div class="card card-primary">
                  ...
                  <form role="form">
                    <div class="card-body">
                     <div class="form-group">
                      ...
                      <select class="form-control form-control-sm" name="nama_kyn" id="nama_kyn" placeholder="Nama Karyawan">
                        ...
                        <?php foreach($nama_kyn as $row) { ?>
                          <option value="<?php echo $row['nama_kyn'] ?>"><?php echo $row['nama_kyn'] ?></option>
                        <?php } ?>
                      </select>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control form-control-sm" name="keperluan" id="keperluan" placeholder="keperluan" value="<?php echo $keperluan; ?>" />
                    </div>
