            ...
            <div class="card">
              ...
              <div class="card-body">
               <form action="" method="post" enctype="multipart/form-data">
                <p><?php echo anchor(site_url('tbl_izin/create'),'Tambah', 'class="btn btn-primary"'); ?></p>
              </div>
              ...
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                  foreach ($tbl_izin_data as $tbl_izin)
                  {
                    ?>
                    <tr>
                     <td width="80px"><?php echo ++$start ?></td>
                     <td><?php echo $tbl_izin->nama_kyn ?></td>
                     <td><?php echo date("d-m-Y", strtotime($tbl_izin->tgl)); ?></td>
                     <td><?php echo $tbl_izin->alasan ?></td>
                     <td><?php echo $tbl_izin->keperluan ?></td>
                     <td style="text-align:center" width="200px">
                     <!-- <a href="<?php echo site_url('tbl_izin/read/'.$tbl_izin->id_kyn) ?>"><i class="fa fa-info"></i></a> | -->
                      <a href="<?php echo site_url('tbl_izin/update/'.$tbl_izin->id_kyn) ?>"><i class="fa fa-edit"></i></a> |
                      <a onClick="return confirm('Anda Yakin ingin Menghapusnya?')" href="<?php echo site_url('tbl_izin/delete/'.$tbl_izin->id_kyn) ?>"><i class="fa fa-trash"></i></a>
                    </td>
                  </tr>
                  <?php
                }
