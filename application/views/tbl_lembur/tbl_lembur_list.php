            ...
            <div class="card">
              ...
              <div class="card-body">
               <form action="" method="post" enctype="multipart/form-data">
                <p><?php echo anchor(site_url('tbl_lembur/create'),'Tambah', 'class="btn btn-primary"'); ?></p>
              </div>
              ...
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                  foreach ($tbl_lembur_data as $tbl_lembur)
                  {
                    ?>
                    <tr>
                     <td width="80px"><?php echo ++$start ?></td>
                     <td><?php echo $tbl_lembur->nama_kyn ?></td>
                     <td><?php echo $tbl_lembur->PIC ?></td>
                     <td><?php echo $tbl_lembur->approval ?></td>
                     <td><?php echo $tbl_lembur->Task ?></td>
                     <td><?php echo date("d-m-Y", strtotime($tbl_lembur->tanggal));  ?></td>
                     <td><?php echo $tbl_lembur->keterangan ?></td>
                     <td style="text-align:center" width="100px">
                      <?php 
				// echo anchor(site_url('tbl_lembur/read/'.$tbl_lembur->id_kyn),' ', 'class="fa fa-info"'); 
				// echo ' | '; 
                      echo anchor(site_url('tbl_lembur/update/'.$tbl_lembur->id_kyn),' ', 'class="fa fa-edit"'); 
                      echo ' | '; 
                      echo anchor(site_url('tbl_lembur/delete/'.$tbl_lembur->id_kyn),' ', 'class="fa fa-trash"','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
                      ?>
                    </td>
                  </tr>
                  <?php
