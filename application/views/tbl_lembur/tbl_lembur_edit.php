                  ...
                  <form role="form">
                    <div class="card-body">
                     <div class="form-group">
                      ...
                      <select class="form-control form-control-sm" name="nama_kyn" >
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control form-control-sm" name="PIC">
                        ...
                        <?php foreach($nama_pic as $row) { ?>
                          <option value="<?php echo $row['nama_pic'] ?>"<?php if($PIC){if($PIC == $row['nama_pic']){echo 'selected'; } } ?>><?php echo $row['nama_pic'] ?></option>
                        <?php } ?>
                      </select>
                    </div>
                    <div class="form-group">
                      ...
                      <select class="form-control form-control-sm" name="approval">
                        ...
                        <?php foreach($app as $row) { ?>
                          <option value="<?php echo $row['app'] ?>" <?php if($approval){if($approval == $row['app']){echo 'selected'; } } ?>><?php echo $row['app'] ?></option>
                        <?php } ?>
                      </select>
                    </div>
                    <div class="form-group">
