                ...
                <div class="card card-primary">
                  ...
                  <form role="form">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control form-control-sm" name="end_date" id="end_date" placeholder="End Date" value="<?php echo $end_date; ?>" />
                    </div>
                    <div class="form-group">
                      ...
                      <select class="form-control form-control-sm" id="status" name="status" placeholder="status">
                        ...
                        <?php foreach($status as $row) { ?>
                          <option value="<?php echo $row['id_stat'] ?>"><?php echo $row['peg'] ?></option>
                        <?php } ?>
                      </select>
                    </div>
                    <div class="form-group">
                      ...
                      <select class="form-control form-control-sm" id="stat_kwn" name="stat_kwn" placeholder="Status Kawin">
                        ...
                        <?php foreach($stat_kwn as $row) { ?>
                          <option value="<?php echo $row['id_stat'] ?>"><?php echo $row['kawin'] ?></option>
                        <?php } ?>
                      </select>
                    </div>
                    <div class="form-group">
